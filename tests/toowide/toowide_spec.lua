...
describe("toowide", function()
  ...
  it("should_disable does not choke on invalid buffer", function()
    local enabled = toowide.should_enable(-1)
    assert(enabled == false, "expected disabled for invalid buffer")
  end)
